...
WebUI.navigateToUrl("https://www.flightstats.com/v2/flight-tracker")
WebUI.selectOptionByValue(findTestObject("Object Repository/Flightstats/airline"), AirAsia, false)
WebUI.delay(2)
WebUI.setText(findTestObject("Object Repository/Flightstats/flightnumber"),"1729")
